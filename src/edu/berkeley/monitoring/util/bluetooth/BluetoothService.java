...
public class BluetoothService{
	...
	public void switchOnBluetooth() {
        ...
        if (D) Log.d(TAG,"switchOnBluetooth()");
...
/**        case PICKFILE_RESULT_CODE:
	...
	public int getPairedDevices(ArrayList<Device> pairedDevicesList) {
        ...
        if (pairedDevices.size() > 0) {
            for (BluetoothDevice device : pairedDevices) {
            	pairedDevicesList.add(new Device(device));
            }    		
        } 
        //TODO:
        return ((int)pairedDevices.size());
        //or
	 ...
	 * 
	 */
	public void unpairDevice(Device targetDevice) throws BluetoothExceptions {		
